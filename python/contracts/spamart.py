...
class FA2(sp.Contract):
    """
    This contract is an experiment from the SPAM ART PARTY [APRIL 2023]

    It is a fork from: teia-smart-contracts/python/contracts/marketplace.py 

    It tries to simplify and extend the FA2 contract template
...
sp.add_compilation_target("fa2", FA2(
    administrator=sp.address("tz1UsTqVAVmMdxWTdPZ5KQTcKxUjqKKU5wDJ"),
    metadata=sp.utils.metadata_of_url("ipfs://bafkreigkk25z2ssvgcp6gbehfezqzthzqheawge6f5z2ljxjdhrulbekl4")))
